...
export function BackgroundEffects() {
    ...
    return (
        <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden bg-black">
            {/* Soft Drifting Glows */}
            <motion.div
                className="absolute top-[-10%] left-[-10%] w-[60%] h-[60%] rounded-full bg-blue-500/5 blur-[120px]"
                animate={{
                    x: [0, 50, -30, 0],
                    y: [0, -40, 60, 0],
                }}
            ...
            />
            <motion.div
                className="absolute bottom-[-10%] right-[-10%] w-[60%] h-[60%] rounded-full bg-purple-500/5 blur-[120px]"
                animate={{
                    x: [0, -60, 40, 0],
                    y: [0, 50, -30, 0],
                }}
