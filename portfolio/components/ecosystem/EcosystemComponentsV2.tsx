...
/**
 * EcosystemComponentsV2 — Enhanced component cards with tilt hover pattern
 */
export function EcosystemComponentsV2() {
  ...
  return (
    ...
    >
      {/* Warm background variant for contrast from blueprint */}
      <SectionBackgroundV2
        variant="warm"
        showGrid={false}
        showNoise={true}
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        >
          {ecosystemComponents.map((component, index) => {
            const colors = ACCENT_COLORS[component.accentColor];
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background: `linear-gradient(90deg, transparent, ${colors.glow.replace(
                      "0.2",
                      "0.5"
                    )}, transparent)`,
                  }}
                ...
                <div className="absolute top-4 right-4">
                  <MonoLabel
                    variant="outline"
                    className={cn(colors.text, "border-current/30")}
                  >
