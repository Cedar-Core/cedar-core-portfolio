...
export function HeroSectionNebula() {
  ...
  return (
    ...
    >
      ...
      {/* === TARGETED NEON ENHANCEMENTS === */}

      {/* 5. Faint Curved Neon Accent - Guided Direction */}
      <div className="absolute inset-x-0 top-[15%] h-[400px] z-0 pointer-events-none opacity-[0.04]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 h-full min-h-[calc(100vh-5rem)] items-center">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="flex flex-col items-start gap-8">
              ...
              <a
                href="ecosystem"
                className="group w-full flex items-center justify-between px-6 py-4 rounded-xl bg-white/3 hover:bg-white/6 border border-white/5 hover:border-white/10 hover:shadow-[0_0_25px_rgba(45,124,255,0.2)] backdrop-blur-md transition-all duration-300"
              >
                <span className="text-sm font-medium text-white/90">Explore ecosystem</span>
                <div className="w-8 h-8 rounded-full bg-blue-600/20 group-hover:bg-blue-600 group-hover:shadow-[0_0_15px_rgba(45,124,255,0.4)] flex items-center justify-center transition-all duration-300">
                  <svg
